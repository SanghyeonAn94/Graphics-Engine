// TypeRegistry.hpp - 타입 레지스트리 헤더 버전
#pragma once
...
// 사용 예제를 위한 테스트 컴포넌트들
namespace Engine::TestComponents {
    struct Transform {
...
namespace Engine::Examples {
    void demonstrateTypeRegistry() {
        ...
        // 타입 ID 가져오기 (런타임)
        auto transformId = GameTypeRegistry::getComponentID<Transform>();
        auto velocityId = GameTypeRegistry::getComponentID<Velocity>();
